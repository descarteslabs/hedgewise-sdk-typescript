 ...
 */
export function getSupplyPhenology(
  client: HedgewiseCore,
  request: operations.GetSupplyPhenologyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetSupplyPhenologyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSupplyPhenologyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/supply/phenology")();
  ...
  const context = {
    ...
    operationID: "get_supply_phenology",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetSupplyPhenologyResponse$inboundSchema),
