 ...
 */
export function mcpOnlyGetFuturesForecastsLlmV1AssetsFuturesForecastsSymbolLlmGet(
...
> {
  ...
  const path = pathToFunc("/v1/assets/futures/forecasts/{symbol}/llm")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID:
      "get_futures_forecasts_llm_v1_assets_futures_forecasts__symbol__llm_get",
    oAuth2Scopes: [],
