...
export function performanceMetricsList(
  ...
  Result<
    components.GetAvailablePerformanceMetricsResponse,
    | HedgewiseError
...
> {
  const path = pathToFunc("/v1/models/performance")();
  ...
  >(
    M.json(
      200,
      components.GetAvailablePerformanceMetricsResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
