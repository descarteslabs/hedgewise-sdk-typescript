...
export function userRegistration(
  ...
  Result<
    void,
    | errors.GetUserRegistrationReponseError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UserRegistration$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/user_registration")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.jsonErr(401, errors.GetUserRegistrationReponseError$inboundSchema),
