 ...
 */
export function mcpOnlyGetFuturesPricesLlmV1AssetsFuturesPricesSymbolLlmGet(
...
> {
  ...
  const path = pathToFunc("/v1/assets/futures/prices/{symbol}/llm")(pathParams);
  ...
  const context = {
    ...
    operationID:
      "get_futures_prices_llm_v1_assets_futures_prices__symbol__llm_get",
    oAuth2Scopes: [],
