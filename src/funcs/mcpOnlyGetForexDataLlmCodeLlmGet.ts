 ...
 */
export function mcpOnlyGetForexDataLlmCodeLlmGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetForexDataLlmCodeLlmGetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/{code}/llm")(pathParams);
  ...
  const context = {
    ...
    operationID: "get_forex_data_llm__code__llm_get",
    oAuth2Scopes: [],
