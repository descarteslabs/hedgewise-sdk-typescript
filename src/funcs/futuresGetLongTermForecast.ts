 ...
 */
export function futuresGetLongTermForecast(
  client: HedgewiseCore,
  request: operations.GetLongTermForecastRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetAssetLongTermForecastsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLongTermForecastRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetAssetLongTermForecastsResponse$inboundSchema),
