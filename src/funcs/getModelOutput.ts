...
export function getModelOutput(
  ...
  Result<
    components.GetModelOutputResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetModelOutputRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/models/output/{symbol}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetModelOutputResponse$inboundSchema),
