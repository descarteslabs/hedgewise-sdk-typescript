 ...
 */
export function mcpOnlyGetFuturesLongTermForecastLlmV1AssetsFuturesForecastsSymbolLongTermForecastLlmGet(
...
> {
  ...
  const path = pathToFunc(
    "/v1/assets/futures/forecasts/{symbol}/long_term_forecast/llm",
  )(pathParams);
  ...
  const context = {
    ...
    operationID:
      "get_futures_long_term_forecast_llm_v1_assets_futures_forecasts__symbol__long_term_forecast_llm_get",
    oAuth2Scopes: [],
