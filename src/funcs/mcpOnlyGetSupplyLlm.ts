 ...
 */
export function mcpOnlyGetSupplyLlm(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSupplyLlmRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/supply/{symbol}/llm")(pathParams);
