 ...
 */
export function featuresGetWeightedIndex(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWeightedIndexRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/features/weighted_index/")();
