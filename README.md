...
```bash
npm add https://github.com/descarteslabs/hedgewise-sdk-typescript
```

### PNPM

```bash
pnpm add https://github.com/descarteslabs/hedgewise-sdk-typescript
```

### Bun

```bash
bun add https://github.com/descarteslabs/hedgewise-sdk-typescript
```

### Yarn

```bash
yarn add https://github.com/descarteslabs/hedgewise-sdk-typescript zod
